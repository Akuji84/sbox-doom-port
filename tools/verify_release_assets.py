...
assets = root / 'Assets'
expected = {
    'blasphem.wad': 'e9ed3f53cb011f1ae897b66fcfe46692c8c2d73e147bbe1e36a9bf1f79a4cc63',
...
for group in ('freedoom', 'freedm', 'freedomscoops', 'blasphemer'):
    for notice in (('COPYING', 'CREDITS', 'CREDITS-MUSIC', 'FDCREDITS') if group == 'freedomscoops' else ('COPYING', 'CREDITS') if group == 'blasphemer' else ('COPYING', 'CREDITS', 'CREDITS-MUSIC')):
...
print('PASS: exactly 6 licensed WADs (Blasphemer preview only); release hashes, licenses and credits verified.')
