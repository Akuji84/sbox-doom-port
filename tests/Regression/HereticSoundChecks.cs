...
static class HereticSoundChecks
{
    ...
    public static void Verify(string root)
    {
        ...
        Check(count == 17, "Encounter sound mapping incomplete.");
        ...
        Console.WriteLine("PASS Heretic sound: seventeen licensed WAD samples, validated DMX decoding and weapon/impact/enemy events");
    }
}
