...
static class HereticSoundChecks
{
    ...
    public static void Verify(string root)
    {
        ...
        Check(count == 22, "Encounter sound mapping incomplete.");
        ...
        Console.WriteLine("PASS Heretic sound: twenty-two licensed WAD samples, validated DMX decoding and weapon/impact/enemy events");
    }
}
