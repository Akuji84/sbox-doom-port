...
static class HereticSoundChecks
{
    ...
    public static void Verify(string root)
    {
        ...
        Check(count == 28, "Encounter sound mapping incomplete.");
        ...
        Console.WriteLine("PASS Heretic sound: twenty-eight licensed WAD samples, validated DMX decoding and weapon/impact/enemy events");
    }
}
