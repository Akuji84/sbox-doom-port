...
static class HereticSoundChecks
{
    ...
    public static void Verify(string root)
    {
        ...
        Check(count == 7, "Encounter sound mapping incomplete.");
        ...
        Console.WriteLine("PASS Heretic sound: seven licensed WAD samples, validated DMX decoding and weapon/impact/enemy events");
    }
}
