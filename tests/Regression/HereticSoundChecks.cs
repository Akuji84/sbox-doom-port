...
static class HereticSoundChecks
{
    ...
    public static void Verify(string root)
    {
        ...
        Check(count == 25, "Encounter sound mapping incomplete.");
        ...
        Console.WriteLine("PASS Heretic sound: twenty-five licensed WAD samples, validated DMX decoding and weapon/impact/enemy events");
    }
}
