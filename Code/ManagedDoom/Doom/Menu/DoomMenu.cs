...
namespace ManagedDoom
{
    public sealed class DoomMenu
    {
        ...
        public DoomMenu(Doom doom)
        {
            ...
            saveUnavailable = new PressAnyKey(
                this,
                "save game is unavailable right now",
                null);
            ...
            optionMenu = new SelectableMenu(
                ...
                new ToggleMenuItem(
                    "M_MESSG", 28, 32, 60, 37, "M_MSGON", "M_MSGOFF", 180,
                    () => video.DisplayMessage ? 0 : 1,
                    value => video.DisplayMessage = value == 0),

                new SliderMenuItem(
                    "M_SCRNSZ", 28, 48, 60, 53,
        ...
        public void NotifySaveUnavailable()
        {
            SetCurrent(saveUnavailable);
        }

        public void NotifyLoadUnavailable()
        {
            SetCurrent(loadUnavailable);
        }
