...
namespace ManagedDoom
{
    ...
    -200637, -152193, -102284, -51389 };
        ...
        internal void Tick()
        {
            ...
            if (Type == HereticActorType.MT_MISC0 || Type == HereticActorType.MT_ITEMSHIELD1 || Type == HereticActorType.MT_ITEMSHIELD2 || Type == HereticActorType.MT_MISC3 || Type == HereticActorType.MT_ARTISUPERHEAL || Type == HereticActorType.MT_ARTIFLY || Type == HereticActorType.MT_ARTIINVULNERABILITY || Type == HereticActorType.MT_MISC4)
            {
