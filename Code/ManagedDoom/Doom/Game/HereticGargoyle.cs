...
namespace ManagedDoom
{
    public sealed partial class HereticClinkTestEnemy
    {
        ...
        private bool SupportsGargoyle(HereticAction action) => action is HereticAction.A_ImpMsAttack2 or
        ...
        {
            if (Combatant.Type == HereticActorType.MT_IMPLEADER && Body.Health <= 0 && Body.Z <= Body.FloorZ &&
