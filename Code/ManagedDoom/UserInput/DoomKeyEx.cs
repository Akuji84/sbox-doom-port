    ...
    public static class DoomKeyEx
    {
        public static char GetChar(this DoomKey key)
        {
            switch (key)
            {
                ...
                case DoomKey.Period:
                    return '.';
                case DoomKey.LessThan:
                    return '<';
                case DoomKey.GreaterThan:
                    return '>';
                case DoomKey.Apostrophe:
                    return '\'';
                case DoomKey.Quote:
                    return '"';
                case DoomKey.Slash:
                    return '/';
                case DoomKey.Question:
                    return '?';
                case DoomKey.Backslash:
                    return '\\';
                case DoomKey.Pipe:
                    return '|';
                case DoomKey.Exclamation:
                    return '!';
                case DoomKey.At:
                    return '@';
                case DoomKey.Hash:
                ...
                case DoomKey.Dollar:
                    return '$';
                case DoomKey.Percent:
                    return '%';
                case DoomKey.Caret:
                    return '^';
                case DoomKey.Ampersand:
                    return '&';
                case DoomKey.LParen:
                    return '(';
                case DoomKey.RParen:
                    return ')';
                case DoomKey.Underscore:
                    return '_';
                case DoomKey.Plus:
                    return '+';
                case DoomKey.LBrace:
        ...
        public static DoomKey Parse(string value)
        {
            switch (value)
            {
                ...
                case "colon":
                    return DoomKey.Colon;
                case "comma":
                    return DoomKey.Comma;
                case "period":
                    return DoomKey.Period;
                case "lessthan":
                    return DoomKey.LessThan;
                case "greaterthan":
                    return DoomKey.GreaterThan;
                case "apostrophe":
                    return DoomKey.Apostrophe;
                case "quote":
                    return DoomKey.Quote;
                case "slash":
                    return DoomKey.Slash;
                case "question":
                    return DoomKey.Question;
                case "backslash":
                    return DoomKey.Backslash;
                case "pipe":
                    return DoomKey.Pipe;
                case "exclamation":
                    return DoomKey.Exclamation;
                case "at":
                    return DoomKey.At;
                case "hash":
                    return DoomKey.Hash;
                case "dollar":
                    return DoomKey.Dollar;
                case "percent":
                    return DoomKey.Percent;
                case "caret":
                    return DoomKey.Caret;
                case "ampersand":
                    return DoomKey.Ampersand;
                case "lparen":
                    return DoomKey.LParen;
                case "rparen":
                    return DoomKey.RParen;
                case "underscore":
                    return DoomKey.Underscore;
                case "plus":
                    return DoomKey.Plus;
                case "lbrace":
                    return DoomKey.LBrace;
                case "rbrace":
                    return DoomKey.RBrace;
                case "backtick":
                    return DoomKey.Backtick;
                case "tilde":
