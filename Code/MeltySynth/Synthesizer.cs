...
namespace MeltySynth
{
    ...
    public sealed class Synthesizer : IAudioRenderer
    {
        ...
        private readonly Preset defaultPreset = Preset.Default;
        ...
        public Synthesizer(SoundFont soundFont, SynthesizerSettings settings)
        {
            ...
            {
                reverbInput = Array.Empty<float>();
                reverbOutputLeft = Array.Empty<float>();
                reverbOutputRight = Array.Empty<float>();
                chorusInputLeft = Array.Empty<float>();
                chorusInputRight = Array.Empty<float>();
                chorusOutputLeft = Array.Empty<float>();
                chorusOutputRight = Array.Empty<float>();
            }
        }
